...
#define LT_SESC  LSFT_T(KC_ESC)
#define LT_CESC  LCTL_T(KC_ESC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        LT_SESC, KC_Z,   KC_X,     KC_C,    LT_2V,   KC_B,    LT_3N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
        _______, KC_LGUI,KC_LALT,  _______, _______, LT_1SPC, _______, _______, _______, LT_1SP,  _______
        ),
